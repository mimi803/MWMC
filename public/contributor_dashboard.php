...
<head>
    ...
    <link rel="icon" type="image/png" href="../assets/imgs/fav.png">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand d-flex align-items-center m-0" href="dashboard.html " target="_blank">
                <span class="font-weight-bold text-lg">Contributor Dashboard</span>
            </a>
        </div>
        <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link  active" href="contributor_dashboard.php">
        ...
        <div class="col-md-12">
            <div class="d-md-flex align-items-center mb-3 mx-2">
                <div class="mb-md-0 mb-3">
                    <h3 class="font-weight-bold mb-0">Hello, Contributor</h3>
                    <p class="mb-0">Thank you for your contribution toward a cleaner world!</p>
                </div>

                <button id="notificationButton" type="button" class="btn btn-sm btn-white btn-icon d-flex align-items-center mb-0 ms-md-auto mb-sm-0 mb-2 me-2" onclick="togglePopup()">
            ...
            <div class="container" style="display: flex; align-items: flex-start; justify-content: center; height: 100vh;">
                
    <!-- Waste Form Card -->
    <div class="card" style="width: 300px; height: auto; display: flex; justify-content: center; align-items: center; margin-right: 20px;">
    <div class="card-body">
        <h3 class="card-title">Sell Your Waste</h3>
