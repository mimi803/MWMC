    ...
    <nav class="navbar bg-slate-900 navbar-expand-lg flex-wrap top-0 px-0 py-0">
      <div class="container py-2">
        <nav aria-label="breadcrumb">
          <div class="d-flex align-items-center">
            <span class="px-3 font-weight-bold text-lg text-white me-4">Farmer Dashboard</span>
          </div>
        </nav>
        <ul class="navbar-nav d-none d-lg-flex">
          <li class="nav-item px-3 py-3 border-radius-sm  d-flex align-items-center">
            <a href="dashboard.html" class="nav-link text-white p-0">
              Dashboard
            </a>
          </li>
          <li class="nav-item px-3 py-3 border-radius-sm  d-flex align-items-center">
            <a href="tables.html" class="nav-link text-white p-0">
              Tables
            </a>
          </li>
          <li class="nav-item px-3 py-3 border-radius-sm bg-slate-800 d-flex align-items-center">
            <a href="wallet.html" class="nav-link text-white p-0">
              Wallet
            </a>
          </li>
      ...
      <div class="container pb-3 pt-3">
        <ul class="navbar-nav d-none d-lg-flex">
          ...
          <li class="nav-item border-radius-sm px-3 py-3 me-2  d-flex align-items-center">
            <a href="sign-in.html" class="nav-link text-white p-0">
              Sign In
            </a>
          </li>
          <li class="nav-item border-radius-sm px-3 py-3 me-2  d-flex align-items-center">
            <a href="sign-up.html" class="nav-link text-white p-0">
              Sign Up
            </a>
          </li>
        </ul>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card blur border border-white mb-4 shadow-xs">
            <div class="card-body p-4">
              ...
              <h3 class="mb-0 font-weight-bold">25,426.70 ksh</h3>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="card blur border border-white mb-4 shadow-xs">
            <div class="card-body p-4">
              ...
              <h3 class="mb-0 font-weight-bold">2,400.10 ksh</h3>
            </div>
          </div>
        </div>
      </div>
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="text-sm">3000 ksh </span>
                    </td>
                    <td>
                      <span class="text-sm">Basic Plan</span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="text-sm">5000 ksh </span>
                    </td>
                    <td>
                      <span class="text-sm">Basic Plan</span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="text-sm">7800 ksh</span>
                    </td>
                    <td>
                      <span class="text-sm">Basic Plan</span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="text-sm">66700 ksh</span>
                    </td>
                    <td>
                      <span class="text-sm">Basic Plan</span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="text-sm">780 ksh </span>
                    </td>
                    <td>
                      <span class="text-sm">Basic Plan</span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="text-sm">300 ksh </span>
                    </td>
                    <td>
                      <span class="text-sm">Basic Plan</span>
                    </td>
                    ...
                    <div class="col-8 my-auto">
                      <div class="d-flex">
                        <div>
                          ...
                          <h3 class="mb-0 font-weight-bold">20,450.80 ksh</h3>
                        </div>
                    ...
                    <div class="col-8 my-auto">
                      <div class="d-flex">
                        <div>
                          ...
                          <p class="text-sm mb-1">Current Balance</p>
                          <h3 class="mb-0 font-weight-bold">10,250.60 ksh</h3>
                        </div>
                        <div class="ms-auto text-end d-flex flex-column">
                          <div class="dropdown">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="ms-auto cursor-pointer dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <div class="row">
                <div class="col-lg-5">
                    ...
                    <div class="card-body text-start ps-3 pe-2 pt-2 pb-2 w-100">
                      <div class="row">
                        <div class="col-8 py-2">
                          <p class="text-white text-sm font-weight-bold mb-6">Farmers connect</p>
                  ...
                  <div class="progress-wrapper w-100 mb-lg-0 mb-5">
                    <div class="d-flex align-items-center mb-2">
                      ...
                      <p class="text-dark font-weight-bold ms-auto mb-0">56,982.20 ksh </p>
                    </div>
                    <div class="progress">
                ...
                <div class="col-lg-5">
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="blur d-flex align-items-center w-100 border-radius-md border border-white mb-4 p-2">
                            <p class="text-white text-sm w-50 mb-0 font-weight-bold">Farmer Connect</p>
                  ...
                  <div class="progress-wrapper w-100">
                    <div class="d-flex align-items-center mb-2">
                      <span class="text-sm font-weight-semibold">This month</span>
                      <p class="text-dark font-weight-bold ms-auto mb-0">16,748.05 ksh </p>
                    </div>
                    <div class="progress">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item border d-flex justify-content-between mb-3 border-radius-md shadow-xs p-3">
              <div class="d-flex align-items-start">
                ...
                <div class="d-flex flex-column">
                  <h6 class="mb-0 text-sm">Freelancer Plan 300 ksh /month</h6>
          ...
          <div class="row align-items-center justify-content-lg-between">
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="h" class="nav-link text-xs text-muted" target="_blank">Mwene</a>
                </li>
                <li class="nav-item">
                  <a href="h" class="nav-link text-xs text-muted" target="_blank">About Us</a>
                </li>
                <li class="nav-item">
                  <a href="h" class="nav-link text-xs text-muted" target="_blank">Blog</a>
                </li>
                <li class="nav-item">
                  <a href="h" class="nav-link text-xs pe-0 text-muted" target="_blank">License</a>
                </li>
              </ul>
            </div>
          </div>
